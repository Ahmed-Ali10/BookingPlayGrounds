...
public class HW4 {
    ...
    public static void main(String[] args) {
        PlayGroundInfo PGF=new PlayGroundInfo("Manchester",20,50,"dareslam",15);
       Player obj=new Player("Ahmed","flashplayer","a@yahoo.com","dareslam","01000000");
       PlayGroundOwner obj2=new PlayGroundOwner("Ahmed","flashplayer","a@yahoo.com","dareslam","01000000",PGF,true);
       ...
       obj.login("a@yahoo.com","flashplayer" );
       obj2.avilable(obj);
       obj.addbook(PGF,15);
